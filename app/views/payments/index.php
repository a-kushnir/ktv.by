...
<div class="accordion" id="payments">
    ...
    <div id="pay_belbank" class="accordion-body collapse">
      <div class="accordion-inner">
        <ol>
          ...
          <li>Предъявите квитанцию или памятку абонента в банке и оплатите услуги ТелеСпутника
        </ol>
        <?php payment_info(); ?>
      </div>
    </div>
  ...
  <div class="accordion-group">
    ...
    <div id="pay_belpost" class="accordion-body collapse">
      <div class="accordion-inner">
        <ol>
          <li>Получите квитанцию или памятку абонента в офисе или по почте
          <li>Предъявите квитанцию или памятку абонента на почте и оплатите услуги ТелеСпутника
        </ol>
        <?php payment_info(); ?>
      </div>
    </div>
  ...
  <div class="accordion-group">
    ...
    <div id="pay_erip" class="accordion-body collapse">
      <div class="accordion-inner">
        <ol>
          <li>Для оплаты наших услуг в меню услуг ЕРИП выберите получателя «ТелеСпутник ООО» в разделе «Интернет, Кабельное ТВ (г. Брест)».
